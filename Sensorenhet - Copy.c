...
void enableInterrupts(){
	...
	MCUR |= _BV(ISC11);				//trigger INT1 on any logic change
...
int main(void)
{
    ...
    while(1)
    {
		...
		if(distanceSensorWait && IRSTOPFLAG){	//om vi väntar på innan vi kan använda avståndssensorn igen kan vi passa på att kolla ir-signaler
